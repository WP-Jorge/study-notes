...
<html>
  ...
  <%
  	...
  	int totalCount=pd.getCount(6);//1待立项总共条数
  		...
  		<table>
  			...
  			<%
  				List<Project> plist = new ArrayList<Project>();
  			  					plist=pd.listByPage(6,np);//查询1状态的项目
  ...
  <form action="checkdelay.jsp" method="post" name="form2">
 <table>
 <tr>  
 <td>共<%out.print(totalCount);%>条记录,共<%out.print(totalpages);%> 页，当前是第<%out.print(np);%>  页</td> 
 <td> 
     <a href="checkdelay.jsp?page=<%=np - 1%>">上一页&nbsp; </a> 
     <a href="checkdelay.jsp?page=<%=np + 1%>">下一页&nbsp;  </a> 
     <a href="checkdelay.jsp?page=1">首页 &nbsp;</a> 
     <a href="checkdelay.jsp?page=<%=totalpages%>">尾页  </a> 
