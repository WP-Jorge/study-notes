...
<html lang="zh-CN">
  ...
  <body>
  	...
  	<a href="applypro.jsp" class="list-group-item" target="main_right">
  	<span class="glyphicon glyphicon-file" aria-hidden="true"></span>&nbsp;&nbsp;项目申请</a>
  	<a href="teacherspro.jsp" class="list-group-item" target="main_right">
