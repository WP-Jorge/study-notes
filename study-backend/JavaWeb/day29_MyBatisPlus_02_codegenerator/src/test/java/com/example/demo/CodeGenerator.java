...
public class CodeGenerator {
	public static void main(String[] args) {
		...
		globalConfig.setOutputDir(projectPath + "/day30_MyBatisPlus_01_codegenerator/src/main/java");
		globalConfig.setAuthor("Jorge");
		...
		dataSourceConfig.setUrl("jdbc:mysql:///user_db?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
		...
		strategy.setInclude("user", "student"); // 设置要映射的表名,多个可用", "分割
