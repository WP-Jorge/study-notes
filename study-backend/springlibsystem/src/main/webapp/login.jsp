			...
			<div class="content">
				...
				<article>
					...
					<div class="input_bar">
						...
						<form action="login.do" method="post" class="login_input">
							...
							<div class="action">
								<input type="submit" class="login btn btn-outline-success" value="登录"/>
								<a href="regist.jsp" class="regiest btn btn-outline-info">去注册</a>
							</div>
						</form>
					</div>
				</article>
