...
ManageObj.jiaolianmingchenGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/paikexinxiguanli/paikexinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'jiaolianxinxi',
guanLianZiDuan : 'jiaolianmingchen'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['jiaolianmingchen']
});

ManageObj.jiaoliandengjiGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/paikexinxiguanli/paikexinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'jiaoliandengji',
guanLianZiDuan : 'jiaoliandengji'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['jiaoliandengji']
});

ManageObj.kechengleixingGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/paikexinxiguanli/paikexinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'kechengleixing',
guanLianZiDuan : 'kechengleixing'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['kechengleixing']
});

ManageObj.shoukeshijianGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/paikexinxiguanli/paikexinxi.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'shoukeshijianduan',
guanLianZiDuan : 'shijianduan'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['shijianduan']
...
fieldLabel : '教练名称',
name : 'jiaolianmingchenSearch',
id : 'jiaolianmingchenSearch',
anchor : '100%'
} ]}
,
{
...
fieldLabel : '教练等级',
name : 'jiaoliandengjiSearch',
id : 'jiaoliandengjiSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '授课名称',
name : 'shoukemingchenSearch',
id : 'shoukemingchenSearch',
anchor : '100%'
},{xtype : 'textfield',
fieldLabel : '课程类型',
name : 'kechengleixingSearch',
id : 'kechengleixingSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '授课时间',
name : 'shoukeshijianSearch',
id : 'shoukeshijianSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '课程描述',
name : 'kechengmiaoshuSearch',
id : 'kechengmiaoshuSearch',
anchor : '100%'
} ]}
  ]
		} ],
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'jiaolianmingchen','jiaoliandengji','shoukemingchen','kechengleixing','shoukeshijian','kechengmiaoshu','id','itime','detail','deleteFlag','erjiguanlianzd' ],
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">教练名称</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'jiaolianmingchen'
} 
, {
header : '<font color="blue">教练等级</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'jiaoliandengji'
} 
, {
header : '<font color="blue">授课名称</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'shoukemingchen'
} 
, {
header : '<font color="blue">课程类型</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kechengleixing'
} 
, {
header : '<font color="blue">授课时间</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'shoukeshijian'
} 
, {
header : '<font color="blue">课程描述</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kechengmiaoshu'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.jiaolianmingchenSearch = document.all.jiaolianmingchenSearch.value; 
ManageObj.dataStore.baseParams.jiaoliandengjiSearch = document.all.jiaoliandengjiSearch.value; 
ManageObj.dataStore.baseParams.shoukemingchenSearch = document.all.shoukemingchenSearch.value; 
ManageObj.dataStore.baseParams.kechengleixingSearch = document.all.kechengleixingSearch.value; 
ManageObj.dataStore.baseParams.shoukeshijianSearch = document.all.shoukeshijianSearch.value; 
ManageObj.dataStore.baseParams.kechengmiaoshuSearch = document.all.kechengmiaoshuSearch.value; 
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;教练名称',
store : ManageObj.jiaolianmingchenGuanLianStore,
valueField : 'jiaolianmingchen',
displayField : 'jiaolianmingchen',
mode : 'remote',
forceSelection : false,
hiddenName : 'jiaolianmingchenHidd',
triggerAction : 'all',
editable : true,
name : 'jiaolianmingchen',
id : 'jiaolianmingchen',
anchor : '95%',
allowBlank : false
}]} 
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;教练等级',
store : ManageObj.jiaoliandengjiGuanLianStore,
valueField : 'jiaoliandengji',
displayField : 'jiaoliandengji',
mode : 'remote',
forceSelection : false,
hiddenName : 'jiaoliandengjiHidd',
triggerAction : 'all',
editable : true,
name : 'jiaoliandengji',
id : 'jiaoliandengji',
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;授课名称',
name : 'shoukemingchen',
id : 'shoukemingchen',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;课程类型',
store : ManageObj.kechengleixingGuanLianStore,
valueField : 'kechengleixing',
displayField : 'kechengleixing',
mode : 'remote',
forceSelection : false,
hiddenName : 'kechengleixingHidd',
triggerAction : 'all',
editable : true,
name : 'kechengleixing',
id : 'kechengleixing',
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;授课时间',
store : ManageObj.shoukeshijianGuanLianStore,
valueField : 'shijianduan',
displayField : 'shijianduan',
mode : 'remote',
forceSelection : false,
hiddenName : 'shoukeshijianHidd',
triggerAction : 'all',
editable : true,
name : 'shoukeshijian',
id : 'shoukeshijian',
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;课程描述',
name : 'kechengmiaoshu',
id : 'kechengmiaoshu',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('jiaolianmingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('jiaolianmingchen');
ManageObj.operationFormPan.findById('jiaoliandengji').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('jiaoliandengji');
ManageObj.operationFormPan.findById('shoukemingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shoukemingchen');
ManageObj.operationFormPan.findById('kechengleixing').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kechengleixing');
ManageObj.operationFormPan.findById('shoukeshijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shoukeshijian');
ManageObj.operationFormPan.findById('kechengmiaoshu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kechengmiaoshu');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/paikexinxiguanli/paikexinxi.do?flag=doExportExcel";
	window.open(  url );
};
