...
ManageObj.kechengmingchenGuanLianStore = new Ext.data.JsonStore({
url : '/WEB-ROOT/app/huiyuanxuankeguanli/huiyuanxuanke.do',
baseParams : {
flag : 'doGuanLian',
guanLianBiao : 'paikexinxi',
guanLianZiDuan : 'shoukemingchen'
},
root : 'root',
totalProperty : 'totalProperty',
fields : ['shoukemingchen']
});
...
{xtype : 'textfield',
fieldLabel : '课程名称',
name : 'kechengmingchenSearch',
id : 'kechengmingchenSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'datefield',
fieldLabel : '选定日期',
name : 'xuandingriqiSearch',
id : 'xuandingriqiSearch',
anchor : '100%'
} ]}
  ]
		} ],
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'huiyuanzhanghao','kechengmingchen','xuandingriqi','id','itime','detail','deleteFlag','erjiguanlianzd' ],
...
, {
header : '<font color="blue">课程名称</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'kechengmingchen'
} 
, {
header : '<font color="blue">选定日期</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'xuandingriqi'
} 
, {
...
ManageObj.dataStore.baseParams.kechengmingchenSearch = document.all.kechengmingchenSearch.value; 
ManageObj.dataStore.baseParams.xuandingriqiSearch = document.all.xuandingriqiSearch.value; 
...
items : [ {
xtype : 'combo',
fieldLabel : '<font color="red">*</font>&nbsp;课程名称',
store : ManageObj.kechengmingchenGuanLianStore,
valueField : 'shoukemingchen',
displayField : 'shoukemingchen',
mode : 'remote',
forceSelection : false,
hiddenName : 'kechengmingchenHidd',
triggerAction : 'all',
editable : true,
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;选定日期',
name : 'xuandingriqi',
id : 'xuandingriqi',
anchor : '95%',
readOnly:true,
...
ManageObj.operationFormPan.findById('kechengmingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kechengmingchen');
ManageObj.operationFormPan.findById('xuandingriqi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xuandingriqi');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/huiyuanxuankeguanli/huiyuanxuanke.do?flag=doExportExcel";
	window.open(  url );
};
