...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'kechengleixing','id','itime','detail','deleteFlag','erjiguanlianzd' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/jianshenjibenshezhi/kechengleixing.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/jianshenjibenshezhi/kechengleixing.do?flag=doExportExcel";
	window.open(  url );
};
