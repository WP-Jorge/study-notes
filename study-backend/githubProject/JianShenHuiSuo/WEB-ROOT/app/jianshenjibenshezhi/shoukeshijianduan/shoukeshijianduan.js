...
{xtype : 'textfield',
fieldLabel : '时间段',
name : 'shijianduanSearch',
id : 'shijianduanSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'shijianduan','id','itime','detail','deleteFlag','erjiguanlianzd' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/jianshenjibenshezhi/shoukeshijianduan.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">时间段</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'shijianduan'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.shijianduanSearch = document.all.shijianduanSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;时间段',
name : 'shijianduan',
id : 'shijianduan',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('shijianduan').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shijianduan');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/jianshenjibenshezhi/shoukeshijianduan.do?flag=doExportExcel";
	window.open(  url );
};
