...
var isChangeAttach = ( ManageObj.oldAttach != nowAttach ) ? 1 : 0 ;
	...
	ManageObj.operationFormPan.getForm().submit({
		waitMsg : '数据提交中......',
		method : 'post',
		url : '/WEB-ROOT/app/jianshenqixieguanli/jianshenqixiexinxi.do?flag=doUpdateSubmit' + 
		      '&id=' + ManageObj.dataGridPan.getStore().getAt(rowIndex).get('id')  + "&erjiguanlianzd=" + erjiguanlianzd + '&isChangeAttach=' + isChangeAttach ,
