...
fieldLabel : '器械名称',
name : 'qixiemingchenSearch',
id : 'qixiemingchenSearch',
anchor : '100%'
} ]}
,
{
...
format : 'Y-m-d',
fieldLabel : '采购时间',
name : 'caigoushijianSearch',
id : 'caigoushijianSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '功能描述',
name : 'gongnenmiaoshuSearch',
id : 'gongnenmiaoshuSearch',
anchor : '100%'
} ]}
  ]
		} ],
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'qixiemingchen','caigoushijian','jiage','gongnenmiaoshu','id','itime','detail','deleteFlag','erjiguanlianzd','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/jianshenqixieguanli/jianshenqixiexinxi.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">器械名称</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'qixiemingchen'
} 
, {
header : '<font color="blue">采购时间</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'caigoushijian'
} 
, {
header : '<font color="blue">价格</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'jiage'
...
, {
header : '<font color="blue">功能描述</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'gongnenmiaoshu'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.qixiemingchenSearch = document.all.qixiemingchenSearch.value; 
ManageObj.dataStore.baseParams.caigoushijianSearch = document.all.caigoushijianSearch.value; 
ManageObj.dataStore.baseParams.jiageSearch = document.all.jiageSearch.value; 
ManageObj.dataStore.baseParams.gongnenmiaoshuSearch = document.all.gongnenmiaoshuSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;器械名称',
name : 'qixiemingchen',
id : 'qixiemingchen',
anchor : '95%',
allowBlank : false
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;采购时间',
name : 'caigoushijian',
id : 'caigoushijian',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;功能描述',
name : 'gongnenmiaoshu',
id : 'gongnenmiaoshu',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
ManageObj.operationFormPan.findById('qixiemingchen').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('qixiemingchen');
ManageObj.operationFormPan.findById('caigoushijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('caigoushijian');
ManageObj.operationFormPan.findById('jiage').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('jiage');
ManageObj.operationFormPan.findById('gongnenmiaoshu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('gongnenmiaoshu');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/jianshenqixieguanli/jianshenqixiexinxi.do?flag=doExportExcel";
	window.open(  url );
};
