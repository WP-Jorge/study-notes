...
url : '/WEB-ROOT/app/jiaolianxinxiguanli/jiaolianxinxi.do',
baseParams : {
flag : 'doGuanLian',
...
format : 'Y-m-d',
fieldLabel : '出生日期',
name : 'chushengriqiSearch',
id : 'chushengriqiSearch',
anchor : '100%'
},{xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '入行时间',
name : 'ruxingshijianSearch',
id : 'ruxingshijianSearch',
anchor : '100%'
} ]}
,
{
...
{xtype : 'textfield',
fieldLabel : '从业经历',
name : 'congyejingliSearch',
id : 'congyejingliSearch',
anchor : '100%'
},{xtype : 'textfield',
fieldLabel : '个人简介',
name : 'gerenjianjieSearch',
id : 'gerenjianjieSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'jiaolianmingchen','xingbie','chushengriqi','ruxingshijian','congyejingli','gerenjianjie','lianxidianhua','id','itime','detail','deleteFlag','erjiguanlianzd','fuJian' ],
...
, {
header : '<font color="blue">出生日期</font>',
width : 60,
align : 'center',
sortable : true,
...
, {
header : '<font color="blue">入行时间</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'ruxingshijian'
} 
, {
header : '<font color="blue">从业经历</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'congyejingli'
} 
, {
header : '<font color="blue">个人简介</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'gerenjianjie'
} 
, {
header : '<font color="blue">联系电话</font>',
width : 60,
align : 'center',
sortable : true,
...
ManageObj.dataStore.baseParams.xingbieSearch = document.all.xingbieSearch.value; 
ManageObj.dataStore.baseParams.chushengriqiSearch = document.all.chushengriqiSearch.value; 
ManageObj.dataStore.baseParams.ruxingshijianSearch = document.all.ruxingshijianSearch.value; 
ManageObj.dataStore.baseParams.congyejingliSearch = document.all.congyejingliSearch.value; 
ManageObj.dataStore.baseParams.gerenjianjieSearch = document.all.gerenjianjieSearch.value; 
...
xtype : 'datefield',
format : 'Y-m-d',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;入行时间',
name : 'ruxingshijian',
id : 'ruxingshijian',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;从业经历',
name : 'congyejingli',
id : 'congyejingli',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;个人简介',
name : 'gerenjianjie',
id : 'gerenjianjie',
anchor : '95%',
allowBlank : false
...
ManageObj.operationFormPan.findById('xingbie').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('xingbie');
ManageObj.operationFormPan.findById('chushengriqi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('chushengriqi');
ManageObj.operationFormPan.findById('ruxingshijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('ruxingshijian');
ManageObj.operationFormPan.findById('congyejingli').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('congyejingli');
ManageObj.operationFormPan.findById('gerenjianjie').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('gerenjianjie');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/jiaolianxinxiguanli/jiaolianxinxi.do?flag=doExportExcel";
	window.open(  url );
};
