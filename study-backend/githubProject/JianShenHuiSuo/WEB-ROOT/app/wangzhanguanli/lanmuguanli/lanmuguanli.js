...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		columns : [ sm, {
			...
			header : '<font color="blue">栏目名称</font>',
			width : 60,
			align : 'center',
			sortable : true,
			dataIndex : 'lanmumingcheng'
		}, {
			header : '<font color="blue">创建人</font>',
			width : 60,
			align : 'center',
			sortable : true,
			dataIndex : 'chuangjianren'
		}, {
			header : "<font color='blue'>操作时间</font>",
			width : 90,
			align : 'center',
			sortable : true,
			dataIndex : 'itime'
	...
	ManageObj.operationFormPan = new Ext.FormPanel({
		...
		items : [ {
			...
			items : [ {
				...
				items : [ {
					xtype : 'textfield',
					fieldLabel : '<font color="red">*</font>&nbsp;创建人',
					name : 'chuangjianren',
					id : 'chuangjianren',
					anchor : '95%',
					allowBlank : false
