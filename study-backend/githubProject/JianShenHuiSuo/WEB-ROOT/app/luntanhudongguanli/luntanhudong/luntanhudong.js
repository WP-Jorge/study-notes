...
{xtype : 'textfield',
fieldLabel : '发表内容',
name : 'fabiaoneirongSearch',
id : 'fabiaoneirongSearch',
anchor : '100%'
} ]}
,
{
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore( {
		...
		remoteSort : true,
		fields : [ 'fabiaotimu','fabiaoneirong','faburen','fabushijian','id','itime','detail','deleteFlag','erjiguanlianzd','fuJian' ],
		proxy : new Ext.data.HttpProxy( {
			url : '/WEB-ROOT/app/luntanhudongguanli/luntanhudong.do',
			method : 'POST'
		}),
		baseParams : {
			flag : 'getJsonStore',
	...
	*/
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel( {
		...
		, {
header : '<font color="blue">发表题目</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'fabiaotimu'
} 
, {
header : '<font color="blue">发表内容</font>',
width : 60,
align : 'center',
sortable : true,
dataIndex : 'fabiaoneirong'
} 
, {
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.fabiaotimuSearch = document.all.fabiaotimuSearch.value; 
ManageObj.dataStore.baseParams.fabiaoneirongSearch = document.all.fabiaoneirongSearch.value; 
...
items : [ {
xtype : 'textfield',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;发表题目',
name : 'fabiaotimu',
id : 'fabiaotimu',
anchor : '95%',
allowBlank : false
...
items : [ {
xtype : 'textarea',
fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;发表内容',
name : 'fabiaoneirong',
id : 'fabiaoneirong',
anchor : '95%',
allowBlank : false
...
,{
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('fabiaotimu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('fabiaotimu');
ManageObj.operationFormPan.findById('fabiaoneirong').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('fabiaoneirong');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/luntanhudongguanli/luntanhudong.do?flag=doExportExcel";
	window.open(  url );
};
