var ManageObj = function() {
	...
	ManageObj.yonghuzhanghaoGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/huiyuanxinxiguanli/zhucehuiyuan.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'user_info',
			guanLianZiDuan : 'userAcct'
		},
		root : 'root',
	...
	ManageObj.huiyuanleixingGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/huiyuanxinxiguanli/zhucehuiyuan.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'huiyuankaleixing',
			guanLianZiDuan : 'kaleixing'
		},
		root : 'root',
		totalProperty : 'totalProperty',
		fields : [ 'kaleixing' ]
	...
	ManageObj.zhifufangshiGuanLianStore = new Ext.data.JsonStore({
		url : '/WEB-ROOT/app/huiyuanxinxiguanli/zhucehuiyuan.do',
		baseParams : {
			flag : 'doGuanLian',
			guanLianBiao : 'zhifufangshi',
			guanLianZiDuan : 'zhifufangshi'
		},
		root : 'root',
		totalProperty : 'totalProperty',
		fields : [ 'zhifufangshi' ]
...
ManageObj.initSearchForm = function() {
	...
	ManageObj.searchForm = new Ext.FormPanel({
				...
				items : [
					{
						...
						xtype : 'textfield',
						fieldLabel : '用户帐号',
						name : 'yonghuzhanghaoSearch',
						id : 'yonghuzhanghaoSearch',
						anchor : '100%'
					}, {
						xtype : 'textfield',
						fieldLabel : '会员类型',
						name : 'huiyuanleixingSearch',
						id : 'huiyuanleixingSearch',
						anchor : '100%'
					} ]
			}
				,
					...
					items : [
						{
							...
							format : 'Y-m-d',
							fieldLabel : '开始时间',
							name : 'kaishishijianSearch',
							id : 'kaishishijianSearch',
							anchor : '100%'
						} ]
				}
				,
					...
					items : [
						{
							...
							format : 'Y-m-d',
							fieldLabel : '到期时间',
							name : 'daoqishijianSearch',
							id : 'daoqishijianSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '剩余次数',
							name : 'shengyucishuSearch',
							id : 'shengyucishuSearch',
							anchor : '100%'
						} ]
				}
				,
					...
					items : [
						{
							xtype : 'textfield',
							fieldLabel : '支付方式',
							name : 'zhifufangshiSearch',
							id : 'zhifufangshiSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '受理人',
							name : 'shoulirenSearch',
							id : 'shoulirenSearch',
							anchor : '100%'
						} ]
				}
					...
					items : [
						{
							xtype : 'datefield',
							fieldLabel : '受理时间',
							name : 'shoulishijianSearch',
							id : 'shoulishijianSearch',
							anchor : '100%'
						}, {
							xtype : 'textfield',
							fieldLabel : '受理状态',
		...
		buttons : [ {
			...
			text : '图形展示',
			hidden :  ( (SP=='y') ? true: ( (R == "y") ? false :  true  )  )   	,
			handler : function() {
				ManageObj.chartWindow = new Ext.Window({
					// maximized : true,
					collapsible : false,
					autoScroll:true,
					modal : true,
					...
					resizable : false,
					layout : 'fit',
					html:"<iframe scrolling=no src='/WEB-ROOT/app/huiyuanxinxiguanli/zhucehuiyuan.do?flag=doChart' frameborder='0' width='100%' height='400' ></iframe>"
				});
				
				
				ManageObj.chartWindow.addButton("返回",function(){
					ManageObj.chartWindow.close();
				});
				
				ManageObj.chartWindow.show();
			}
		}, {
			text : '导出Excel',
			hidden : ( (R == "y") ? true : (   (BUTTON_PLACE == "0") ? false : true )   ),
...
ManageObj.initDataGridPan = function() {
	...
	ManageObj.dataStore = new Ext.data.JsonStore({
		...
		totalProperty : 'totalProperty',
		remoteSort : true,
		fields : [ 'yonghuzhanghao', 'huiyuanleixing', 'kaishishijian', 'daoqishijian', 'shengyucishu', 'zhifufangshi', 'shouliren', 'shoulishijian', 'shenpi', 'id', 'itime', 'detail', 'deleteFlag', 'erjiguanlianzd', 'fuJian' ],
	...
	ManageObj.dataGridPan = new Ext.grid.GridPanel({
		...
		columns : [
			...
			*/
			...
			, {
				header : '<font color="blue">用户帐号</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'yonghuzhanghao'
			}
			, {
				header : '<font color="blue">会员类型</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'huiyuanleixing'
			}
			, {
				header : '<font color="blue">开始时间</font>',
				width : 60,
				align : 'center',
				sortable : true,
			...
			, {
				header : '<font color="blue">到期时间</font>',
				width : 60,
				align : 'center',
				sortable : true,
			...
			, {
				header : '<font color="blue">剩余次数</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'shengyucishu'
			}
			, {
				header : '<font color="blue">支付方式</font>',
				width : 60,
				align : 'center',
				sortable : true,
			...
			, {
				header : '<font color="blue">受理人</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'shouliren'
			...
			, {
				header : '<font color="blue">受理时间</font>',
				width : 60,
				align : 'center',
				sortable : true,
			...
			, {
				header : '<font color="blue">受理状态</font>',
				width : 60,
				align : 'center',
				sortable : true,
				dataIndex : 'shenpi'
...
ManageObj.doSearch = function() {
	...
	ManageObj.dataStore.baseParams.yonghuzhanghaoSearch = document.all.yonghuzhanghaoSearch.value;
	ManageObj.dataStore.baseParams.huiyuanleixingSearch = document.all.huiyuanleixingSearch.value;
	ManageObj.dataStore.baseParams.kaishishijianSearch = document.all.kaishishijianSearch.value;
	ManageObj.dataStore.baseParams.daoqishijianSearch = document.all.daoqishijianSearch.value;
	ManageObj.dataStore.baseParams.shengyucishuSearch = document.all.shengyucishuSearch.value;
	ManageObj.dataStore.baseParams.zhifufangshiSearch = document.all.zhifufangshiSearch.value;
	ManageObj.dataStore.baseParams.shoulirenSearch = document.all.shoulirenSearch.value;
	ManageObj.dataStore.baseParams.shoulishijianSearch = document.all.shoulishijianSearch.value;
	ManageObj.dataStore.baseParams.shenpiSearch = document.all.shenpiSearch.value;
...
ManageObj.getOperationFormPan = function(rowIndex, flag) {
		...
		items : [ {
			...
			items : [ {
				...
				items : [ {
					...
					store : ManageObj.yonghuzhanghaoGuanLianStore,
					valueField : 'userAcct',
					displayField : 'userAcct',
					mode : 'remote',
					forceSelection : false,
					hiddenName : 'yonghuzhanghaoHidd',
					triggerAction : 'all',
					editable : true,
					name : 'yonghuzhanghao',
					id : 'yonghuzhanghao',
				...
				, {
					...
					items : [ {
						xtype : 'combo',
						fieldLabel : '<font color="red">*</font>&nbsp;会员类型',
						store : ManageObj.huiyuanleixingGuanLianStore,
						valueField : 'kaleixing',
						displayField : 'kaleixing',
						mode : 'remote',
						forceSelection : false,
						hiddenName : 'huiyuanleixingHidd',
						triggerAction : 'all',
						editable : true,
						name : 'huiyuanleixing',
						id : 'huiyuanleixing',
				...
				, {
					...
					items : [ {
						xtype : 'combo',
						fieldLabel : '<font color="red">*</font>&nbsp;支付方式',
						store : ManageObj.zhifufangshiGuanLianStore,
						valueField : 'zhifufangshi',
						displayField : 'zhifufangshi',
						mode : 'remote',
						forceSelection : false,
						hiddenName : 'zhifufangshiHidd',
						triggerAction : 'all',
						editable : true,
						name : 'zhifufangshi',
						id : 'zhifufangshi',
				...
				, {
					...
					items : [ {
						xtype : 'textfield',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;受理人',
						name : 'shouliren',
						id : 'shouliren',
						anchor : '95%',
						readOnly : true,
				...
				, {
					...
					items : [ {
						xtype : 'datefield',
						format : 'Y-m-d',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;受理时间',
						name : 'shoulishijian',
						id : 'shoulishijian',
						anchor : '95%',
						readOnly : true,
				...
				, {
					...
					items : [ {
						xtype : 'textfield',
						fieldLabel : '<font color="red">*</font>&nbsp;&nbsp;受理状态',
						name : 'shenpi',
						id : 'shenpi',
						anchor : '95%',
						readOnly : true,
	...
	if (rowIndex != null) {
		ManageObj.operationFormPan.findById('yonghuzhanghao').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('yonghuzhanghao');
		ManageObj.operationFormPan.findById('huiyuanleixing').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('huiyuanleixing');
		ManageObj.operationFormPan.findById('kaishishijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('kaishishijian');
		ManageObj.operationFormPan.findById('daoqishijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('daoqishijian');
		ManageObj.operationFormPan.findById('shengyucishu').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shengyucishu');
		ManageObj.operationFormPan.findById('zhifufangshi').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('zhifufangshi');
		ManageObj.operationFormPan.findById('shouliren').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shouliren');
		ManageObj.operationFormPan.findById('shoulishijian').value = ManageObj.dataGridPan.getStore().getAt(rowIndex).get('shoulishijian');
...
ManageObj.doExportExcel = function() {
	var url = "/WEB-ROOT/app/huiyuanxinxiguanli/zhucehuiyuan.do?flag=doExportExcel";
	window.open(url);
};
