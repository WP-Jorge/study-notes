package  app.paikexinxiguanli.paikexinxi;
...
public class Paikexinxi extends BaseFormController {
    //业务处理方法
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            if (flag != null && flag.equals("getJsonStore")) {
                ...
                return toFinish("/WEB-ROOT/app/paikexinxiguanli/paikexinxi/paikexinxi.jsp", resultMap, request,  response);
            }
            //提交数据库
    ...
    public ModelAndView doGetJsonStore(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String jiaolianmingchenSearch = request.getParameter("jiaolianmingchenSearch"); 
 if( jiaolianmingchenSearch != null && !jiaolianmingchenSearch.equals("") ){  
 	 where.put("jiaolianmingchenSearch", jiaolianmingchenSearch);  
 } 
String jiaoliandengjiSearch = request.getParameter("jiaoliandengjiSearch"); 
 if( jiaoliandengjiSearch != null && !jiaoliandengjiSearch.equals("") ){  
 	 where.put("jiaoliandengjiSearch", jiaoliandengjiSearch);  
 } 
String shoukemingchenSearch = request.getParameter("shoukemingchenSearch"); 
 if( shoukemingchenSearch != null && !shoukemingchenSearch.equals("") ){  
 	 where.put("shoukemingchenSearch", shoukemingchenSearch);  
 } 
String kechengleixingSearch = request.getParameter("kechengleixingSearch"); 
 if( kechengleixingSearch != null && !kechengleixingSearch.equals("") ){  
 	 where.put("kechengleixingSearch", kechengleixingSearch);  
 } 
String shoukeshijianSearch = request.getParameter("shoukeshijianSearch"); 
 if( shoukeshijianSearch != null && !shoukeshijianSearch.equals("") ){  
 	 where.put("shoukeshijianSearch", shoukeshijianSearch);  
 } 
String kechengmiaoshuSearch = request.getParameter("kechengmiaoshuSearch"); 
 if( kechengmiaoshuSearch != null && !kechengmiaoshuSearch.equals("") ){  
 	 where.put("kechengmiaoshuSearch", kechengmiaoshuSearch);  
 } 
...
if( !SysInfo.getLoginUserType(request, response).equals("1") ){ 
	   where.put("dataRight",  "  a.operatorId='"+SysInfo.getLoginUserId(request, response)+"'  " );
            ...
            //根据查询条件获取数据
            String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Paikexinxi.selecteList");
    ...
    public ModelAndView doAdd(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String jiaolianmingchen = request.getParameter("jiaolianmingchenHidd"); 
where.put("jiaolianmingchen", jiaolianmingchen);  
String jiaoliandengji = request.getParameter("jiaoliandengjiHidd"); 
where.put("jiaoliandengji", jiaoliandengji);  
String shoukemingchen = request.getParameter("shoukemingchen"); 
where.put("shoukemingchen", shoukemingchen);  
String kechengleixing = request.getParameter("kechengleixingHidd"); 
where.put("kechengleixing", kechengleixing);  
String shoukeshijian = request.getParameter("shoukeshijianHidd"); 
where.put("shoukeshijian", shoukeshijian);  
String kechengmiaoshu = request.getParameter("kechengmiaoshu"); 
where.put("kechengmiaoshu", kechengmiaoshu);  
...
where.put("erjiguanlianzd", erjiguanlianzd);  
            ...
            //向数据库新增数据
            sqlMap.insert("Paikexinxi.insertObj", where);
    ...
    public ModelAndView doAddWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
            ...
            //新增数据
		    sqlMap.insert("Paikexinxi.insertObj", whereMap);
...
where.put("erjiguanlianzd", erjiguanlianzd);  
            ...
            //向数据库提交修改数据
            sqlMap.update("Paikexinxi.updateObj", where);
    ...
    public ModelAndView doUpdateWithAttach(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			//向数据库提交修改信息
		    sqlMap.update("Paikexinxi.updateObj", whereMap);
    ...
    public ModelAndView doDeleOrUnDele(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            //向数据库提交删除数据
            sqlMap.delete("Paikexinxi.doDeleOrUnDele", where);
     ...
     public ModelAndView doShenPi(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            //向数据库提交审批信息
            sqlMap.delete("Paikexinxi.doShenPi", where);
...
if( !SysInfo.getLoginUserType(request, response).equals("1") ){ 
    ...
    public static ModelAndView doExportExcel(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			// 根据查询条件得到结果集
			HashMap<String, Object> where = new HashMap<String, Object>();
			List<Object> listInfo = sqlMap.queryForList("Paikexinxi.selecteList", where);
	...
	public static WritableSheet refreashSheet(List<Object> al, WritableSheet ws) throws Exception {
       ...
       //样式5
		...
		// 设置表头(列号,行号 ,内容 )
		 Label label_0 = new Label(1, 3, "教练名称", wcfFC5);  
 ws.addCell(label_0); 
 Label label_1 = new Label(2, 3, "教练等级", wcfFC5);  
 ws.addCell(label_1); 
 Label label_2 = new Label(3, 3, "授课名称", wcfFC5);  
 ws.addCell(label_2); 
 Label label_3 = new Label(4, 3, "课程类型", wcfFC5);  
 ws.addCell(label_3); 
 Label label_4 = new Label(5, 3, "授课时间", wcfFC5);  
 ws.addCell(label_4); 
 Label label_5 = new Label(6, 3, "课程描述", wcfFC5);  
 ws.addCell(label_5); 
 Label label_6 = new Label(7, 3, "Id", wcfFC5);  
 ws.addCell(label_6); 
 Label label_7 = new Label(8, 3, "创建时间", wcfFC5);  
 ws.addCell(label_7); 
 Label label_8 = new Label(9, 3, "备注", wcfFC5);  
 ws.addCell(label_8); 


		//设置表体
		for (int i = 0; i < al.size(); i++) { String jiaolianmingchen = ((HashMap) (al.get(i))).get("jiaolianmingchen").toString();  
 label_0 = new Label(1, i + 4, jiaolianmingchen, wcfF4); 
 ws.addCell(label_0); 
 String jiaoliandengji = ((HashMap) (al.get(i))).get("jiaoliandengji").toString();  
 label_1 = new Label(2, i + 4, jiaoliandengji, wcfF4); 
 ws.addCell(label_1); 
 String shoukemingchen = ((HashMap) (al.get(i))).get("shoukemingchen").toString();  
 label_2 = new Label(3, i + 4, shoukemingchen, wcfF4); 
 ws.addCell(label_2); 
 String kechengleixing = ((HashMap) (al.get(i))).get("kechengleixing").toString();  
 label_3 = new Label(4, i + 4, kechengleixing, wcfF4); 
 ws.addCell(label_3); 
 String shoukeshijian = ((HashMap) (al.get(i))).get("shoukeshijian").toString();  
 label_4 = new Label(5, i + 4, shoukeshijian, wcfF4); 
 ws.addCell(label_4); 
 String kechengmiaoshu = ((HashMap) (al.get(i))).get("kechengmiaoshu").toString();  
 label_5 = new Label(6, i + 4, kechengmiaoshu, wcfF4); 
 ws.addCell(label_5); 
 String id = ((HashMap) (al.get(i))).get("id").toString();  
 label_6 = new Label(7, i + 4, id, wcfF4); 
 ws.addCell(label_6); 
 String itime = ((HashMap) (al.get(i))).get("itime").toString();  
 label_7 = new Label(8, i + 4, itime, wcfF4); 
 ws.addCell(label_7); 
 String detail = ((HashMap) (al.get(i))).get("detail").toString();  
 label_8 = new Label(9, i + 4, detail, wcfF4); 
 ws.addCell(label_8); 
 } 
	...
	public ModelAndView doAddPicSubmit(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			//查询图片信息
			List list = sqlMap.queryForList("Paikexinxi.getTuPianIndex", whereMap);
			if( list != null && list.size() > 0 ){
				if( list.get(0) != null ){
			...
			if( tuPianIndex.equals("") ){
				...
				sqlMap.update("Paikexinxi.updateTuPianIndex", whereMap);
				...
				if ( !item.isFormField()) {
				   //获取文件名称
					...
					if( ! new File( uploadPath ).exists() ){
						whereMap.put("operatorId", SysInfo.getLoginUserId(request, response));
						whereMap.put("tuPianIndex", tuPianIndex);
						sqlMap.insert("Paikexinxi.insertTuPian", whereMap);
					}
	...
	public ModelAndView doGetPicJsonStore(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			//得到查询图片结果信息
			String json = IbatisUtil.queryForPage(sqlMap, request, response, where, "Paikexinxi.selectePicList");
	...
	public ModelAndView doDelePic(SqlMapClient sqlMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    try {
		    ...
		    //向数据库提交删除信息
		    sqlMap.delete("Paikexinxi.doDelePic", where);
