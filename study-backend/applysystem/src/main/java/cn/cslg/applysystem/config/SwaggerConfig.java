...
public class SwaggerConfig {
	...
	public Docket docket(Environment environment) {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("cn.cslg.applysystem.controller"))
				// paths() 过滤什么路径
	...
	private ApiInfo apiInfo() {
		// 作者信息
		Contact contact = new Contact("applysystem", "http://localhost:8081", "853539461@qq.com");
		return new ApiInfo(
				"applysystem接口",
				"applysystemAPI接口",
				"1.0",
