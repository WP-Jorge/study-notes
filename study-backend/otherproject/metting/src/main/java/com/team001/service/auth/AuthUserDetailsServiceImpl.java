package com.team001.service.auth;
...
//                System.out.println("authUserDetial:::::@#############"+role);
                authorities.add(new SimpleGrantedAuthority(role));
            }
//            System.out.println("loadUserByUsername......user ===> " + user);
            return new AuthUser(user.getUsername(), user.getPassword(), user.getEnabled(), authorities);
        }
    }
}
