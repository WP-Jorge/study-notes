...
<template>
	<div class="music-item">
		<div class="card-content">
			<div class="image">
				<img
					v-if="showOptions.showImg"
					:src="music.album.albumPic"
					:alt="music.musicTitle" />
				<div v-if="showOptions.showTitle" class="title ellipse">
					{{ music.musicTitle }}
				</div>
			</div>
			<div v-if="showOptions.showSingers" class="singers ellipse">
				{{ music.singers.map(singer => singer.singerName).join(' / ') }}
			</div>
