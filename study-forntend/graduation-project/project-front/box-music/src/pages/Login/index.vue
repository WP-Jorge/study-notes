<template>
	...
	<div>
		验证码：
		<img :src="verificationCodeImg" alt="验证码" @click="getVerifyCode" />
	</div>
	<br />
...
let getVerifyCode = async () => {
	let res = await getVerificationCodeApi(codeId.value);
	console.log(res);
	verificationCodeImg.value = res.data.VerificationCodeBase64;
};
