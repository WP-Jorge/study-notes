<template>
	...
	请选择你的音乐文件夹：<input ref="dir" @change="dirSelected" type="file" webkitdirectory directory />
...
// ffmpeg.setFfmpegPath(ffmpegPath.path);
// ffmpeg.setFfprobePath(ffprobePath.path);
// ffmpeg.ffprobe('D:/音乐/漫长的告白-双笙-162283619.flac', function (err: any, metadata: any) {
// 	console.log(err);
...
ffmpeg.ffprobe('G:/Musics/1/红昭愿-452986458.mp3', function (err: any, metadata: any) {
	// console.log(err);
	console.dir(metadata);
