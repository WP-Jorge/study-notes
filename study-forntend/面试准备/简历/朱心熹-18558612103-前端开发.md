		...
		<div class="skill">
			...
			<div class="content">
                ...
                <div class="margin-top-5px simple-fort row">
                    <strong>后端</strong>：熟悉 <strong>Spring Boot</strong>、<strong>Mybatis Plus</strong>、<strong>Mysql</strong> 的基本使用；了解 <strong>Spring Security</strong>、<strong>Redis</strong> 
                    的基本用法
                </div>
			</div>
		</div>
